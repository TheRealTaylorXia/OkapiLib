...
execute_process(
  COMMAND "/usr/bin/git" show-ref 1.1.1
  WORKING_DIRECTORY "/home/willxu/repos/BLRS/OkapiLib/squiggles-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/1.1.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1.1.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 1.1.1
  WORKING_DIRECTORY "/home/willxu/repos/BLRS/OkapiLib/squiggles-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/baylessj/robotsquiggles.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/willxu/repos/BLRS/OkapiLib/squiggles-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/willxu/repos/BLRS/OkapiLib/squiggles-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
